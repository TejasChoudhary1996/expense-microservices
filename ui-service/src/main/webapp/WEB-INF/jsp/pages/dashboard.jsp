...
<div class="col-md-2">
<input type="date" name="expenseDate" value="<%= java.time.LocalDate.now() %>" class="form-control" required>
</div>
...
<button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#paymentModal">+</button>
</div>
</div>
